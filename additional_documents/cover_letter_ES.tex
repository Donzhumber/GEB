...
\noindent Estimados Editores de \textit{Games and Economic Behavior},

\vspace{1.5em}

\noindent Es un gran privilegio presentar el manuscrito titulado \textbf{``Identifying Rational Types in Unknown Environments under an Indirect Dynamic Mechanism''} para su consideración de publicación en \textit{Games and Economic Behavior}.
