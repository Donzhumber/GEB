...
\noindent Dear Editors of \textit{Games and Economic Behavior},

\vspace{1.5em}

\noindent It is a great privilege to submit the manuscript entitled \textbf{``Identifying Rational Types in Unknown Environments under an Indirect Dynamic Mechanism''} for consideration for publication in \textit{Games and Economic Behavior}.
