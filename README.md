...
*   `Bernal_H_JET.tex`: The main LaTeX source file formatted for the *Journal of Economic Theory*.
...
This directory contains the administrative documents prepared for the Editorial Manager submission to the *Journal of Economic Theory*:
